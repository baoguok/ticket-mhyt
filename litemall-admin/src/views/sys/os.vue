<template>
  <div class="app-container">
    ...
    <!-- 添加对话框 -->
    <el-dialog :visible.sync="createDialogVisible" title="上传对象" width="38%">
    ...
    <!-- 修改对话框 -->
    <el-dialog :visible.sync="updateDialogVisible" title="修改对象名称" width="38%">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin:auto;">
