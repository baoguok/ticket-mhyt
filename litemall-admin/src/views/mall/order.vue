<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-alert type="warning" show-icon>您有{{ apply }}条退款申请待处理</el-alert>
    </div>
    <!-- 查询结果 -->
...
<script>
import { listOrder, shipOrder, refundOrder, detailOrder, countRefundApply } from '@/api/order'
...
//   websocket = new WebSocket('ws://j239f72446.qicp.vip:16545/wx/websocket')
// } else {
