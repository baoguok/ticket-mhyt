...
import org.linlinjava.litemall.db.service.LitemallAddressOldService;
...
public class WxAddressController extends GetRegionService {
	...
	@Autowired
	private LitemallAddressOldService addressService;
	...
	public Object list(@LoginUser Integer userId) {
		...
		List<LitemallAddressOld> addressList = addressService.queryByUid(userId);
		List<Map<String, Object>> addressVoList = new ArrayList<>(addressList.size());
		List<LitemallRegion> regionList = getLitemallRegions();
		for (LitemallAddressOld address : addressList) {
	...
	public Object detail(@LoginUser Integer userId, @NotNull Integer id) {
		...
		LitemallAddressOld address = addressService.findById(id);
		if (address == null) {
	...
	private Object validate(LitemallAddressOld address) {
	 ...
	 */
	@PostMapping("save")
	public Object save(@LoginUser Integer userId, @RequestBody LitemallAddressOld address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
	 ...
	 */
	@PostMapping("delete")
	public Object delete(@LoginUser Integer userId, @RequestBody LitemallAddressOld address) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
