...
public class AdminOrderController {
     ...
     * @return 退款申请订单数
     */
    @RequiresPermissions("admin:order:countRefundApply")
    @GetMapping("/countRefundApply")
    public Object countRefundApply() {
        return adminOrderService.countRefundApply();
    }
    ...
    * @return 待发货订单数
    */
   @RequiresPermissions("admin:order:countShipOrder")
   @GetMapping("/countShipOrder")
   public Object countShipOrder() {
       return adminOrderService.countShipOrder();
   }
