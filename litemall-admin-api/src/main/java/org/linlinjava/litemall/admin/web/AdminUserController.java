...
public class AdminUserController {
    ...
    public Object list(String nickname, String mobile,
        ...
        List<TicUser> userList = userService.querySelective(nickname, mobile, page, limit, sort, order);
    ...
    private Object validate(TicUser user) {
        ...
        String mobile = user.getUseMobile();
    ...
    @PostMapping("/create")
    public Object create(@RequestBody TicUser user) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody TicUser user) {
        Object error = validate(user);
        if (error != null) {
            return error;
        }
        ...
        TicUser newuser = new TicUser();
        newuser.setUseLevel(user.getUseLevel());
        newuser.setUseStatus(user.getUseStatus());
        newuser.setUseId(user.getUseId());
