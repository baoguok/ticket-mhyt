...
public class ResponseUtil {
    ...
    public static Object badGoodsValue() {
        return fail(403, "商品不存在或商品名输入有误");
    }
    ...
    public static Object userd(Object data){return fail(201,"此门票已使用",data);}

    public static Object testFail(Object data){return fail(202,"验证失败,请重试",data);}

    public static Object warn(Object data){return fail(203,"警报,非法闯入",data);}

    public static Object noBack(){return fail(101,"该门票不在退票时期内");}
}
