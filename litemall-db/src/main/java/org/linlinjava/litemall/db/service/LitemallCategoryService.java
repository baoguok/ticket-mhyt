...
public class LitemallCategoryService {
    ...
    public List<LitemallCategory> querySelective(String id, String level, Integer page, Integer size, String sort, String order) {
        LitemallCategoryExample example = new LitemallCategoryExample();
        ...
        if (!StringUtils.isEmpty(level)) {
        	if("二级类目".equals(level)) {
        		level = "L2";
        	}else if("一级类目".equals(level)){
        		level = "L1";
        	}
